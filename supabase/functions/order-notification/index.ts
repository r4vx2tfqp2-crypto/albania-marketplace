...
serve(async (req) => {
  try {
    ...
    if (type === 'delivery_confirmed') {
      // Email to admin when delivery is confirmed
      emailBody = {
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background: #F7F6F3; padding: 24px; border-radius: 0 0 12px 12px;">
              <h2 style="font-size: 18px; margin: 0 0 16px;">Order #${order.id?.slice(0, 8)} has been delivered</h2>
              ...
              <div style="background: #fff; padding: 16px; border-radius: 8px; margin-bottom: 16px;">
                <h3 style="margin: 0 0 8px; font-size: 14px; color: #9A9890;">ITEMS DELIVERED</h3>
              ...
              <div style="background: #1D9E75; padding: 16px; border-radius: 8px; text-align: center;">
                ...
                <p style="margin: 4px 0 0; color: rgba(255,255,255,0.7); font-size: 13px;">Cash on delivery — collect payment</p>
              </div>
